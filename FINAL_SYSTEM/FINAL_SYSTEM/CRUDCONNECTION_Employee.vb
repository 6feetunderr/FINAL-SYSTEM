...
Module CRUDCONNECTION_Employee
    ...
    Public Sub add_data(ByVal sql As String)
        Try
            strcon.Open()
            With cmd
                .Connection = strcon
    ...
    'RETRIEVING DATA
    Public Sub refresh_data(ByVal sql As String, ByVal DTG As Object)
        Try
            dt = New DataTable
            strcon.Open()
            With cmd
    ...
    Public Sub edit_data(ByVal sql As String)
        Try
            strcon.Open()
            With cmd
                .Connection = strcon
